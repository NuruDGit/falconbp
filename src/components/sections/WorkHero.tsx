      ...
      <div className="max-w-300 mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-technical mb-12 leading-[1.1] tracking-tight">
            <span className="text-white">Decision-led,</span>
            <br className="hidden md:block" />{" "}
            <span className="text-brand-gold italic font-cinzel opacity-90">
              not topic-led.
            </span>
          </h1>
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-white/60 text-lg md:text-xl font-light leading-relaxed">
              The work is anchored to a specific decision at all times, protecting
              clarity, constraining scope and ensuring every conversation strengthens
              judgement. We do not take authority away from leaders. We make the
              thinking sharper so the decision can be owned, defended and executed
              with confidence.
            </p>

            {/* Integration sentence */}
            <p className="mt-6 text-white/60 text-lg md:text-xl font-light leading-relaxed">
              These are not separate services. They are three dimensions of the same
              decision support process, working together to strengthen judgement
              before, during and after critical decisions.
            </p>
          </div>
        </div>
      </div>
